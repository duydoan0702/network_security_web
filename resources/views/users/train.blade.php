    ...
    @section('content')
        ...
        <section class="why-cybrary" id="train">
          ...
          <div class="icons">
            <div class="icon-card">
            <img src="{{asset('public/frontend/images/user/career.png')}}" alt="Launch Your Career Icon" />    <h2>Khởi Động Sự Nghiệp Của Bạn</h2>
              <p>
            ...
            <div class="icon-card">
              <img src="{{asset('public/frontend/images/user/join.png')}}" alt="Onboard Team Members Icon" />
            ...
            <div class="icon-card">
              <img
                src="{{asset('public/frontend/images/user/certificate.png')}}"    alt="Earn Certifications Icon"
              />
            ...
            <div class="icon-card">
            <img src="{{asset('public/frontend/images/user/skill.png')}}" alt="Upskill and Practice Icon" />    <h2>Nâng Cao Kĩ Năng & Thực Hành</h2>
              <p>
            ...
            <div class="icon-card">
            <img src="{{asset('public/frontend/images/user/talent.png')}}" alt="Retain Top Talent Icon" />    <h2>Giữ Chân Nhân Tài Hàng Đầu</h2>
              <p>
            ...
            <div class="icon-card">
              <img
                src="{{asset('public/frontend/images/user/reduce.png')}}"    alt="Reduce Business Risk Icon"
              />
